    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Dokan",style: TextStyle(fontSize: 21.18,
            ...
            Color(0xffFF5934),letterSpacing: -1.74,fontFamily: "KronaOne"),),
        centerTitle: true,
        actions: [
          // Image Button
          Padding(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset("assets/images/bigsale.png"),
          SizedBox(height: 20,),
        Padding(
          padding: const EdgeInsets.only(left: 20,right: 20),
          child: customTextField(hintText: "Search",
            controller: name,prefixImage: "assets/images/serach.png",),
        ),
            ...
            Padding(
              ...
              child: GridView.builder(
                shrinkWrap: true, // 👈 so it doesn’t take full height
            ...
            Padding(
              ...
              child: Text("Recommended for you",style: TextStyle(fontSize: 18,letterSpacing: -1,
