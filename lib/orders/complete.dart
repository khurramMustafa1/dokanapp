...
import 'package:internshipproject2/midel/ordermodel.dart';
import 'package:internshipproject2/orders/ordrdetail.dart' show order_Detail;
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: Color(0x2117B556),
                      borderRadius: BorderRadius.circular(10),
                    ),
                    child: Text(
                      order.status,
                      style: TextStyle(color:Color(0xff17B556), fontSize: 12,
                          fontWeight: FontWeight.w500, fontFamily: "Inter", letterSpacing: -1
                      ),
                    ),
                  ),
